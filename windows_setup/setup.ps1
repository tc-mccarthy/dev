...
if ($PSVersionTable.PSVersion.Major -le 2)
{
  ...
  choco install -y dotnet4.7 powershell python3 googlechrome firefox sublimetext3 slack openssh nodejs ruby git curl atom avgantivirusfree malwarebytes ccleaner winrar
  choco upgrade -y dotnet4.7 powershell python3 googlechrome firefox sublimetext3 slack openssh nodejs ruby git curl atom avgantivirusfree malwarebytes ccleaner winrar
...
choco install -y --ignore-checksums powershell python3 googlechrome firefox sublimetext3 slack openssh nodejs ruby git curl atom avgantivirusfree malwarebytes ccleaner winrar
choco upgrade -y --ignore-checksums powershell python3 googlechrome firefox sublimetext3 slack openssh nodejs ruby git curl atom avgantivirusfree malwarebytes ccleaner winrar
