...
choco install -y --ignore-checksums powershell python3 googlechrome firefox sublimetext3 slack openssh nodejs ruby git curl atom avgantivirusfree malwarebytes ccleaner
choco upgrade -y --ignore-checksums powershell python3 googlechrome firefox sublimetext3 slack openssh nodejs ruby git curl atom avgantivirusfree malwarebytes ccleaner
